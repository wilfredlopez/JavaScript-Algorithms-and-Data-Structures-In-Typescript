...
describe("DoublyLinkedList", () => {
  ...
  it("should be possible to store objects in the list and to print them out", () => {
    const linkedList = new DoublyLinkedList<KeyValue>()
  ...
  it("should find node by means of custom compare function", () => {
    ...
    const linkedList = new DoublyLinkedList<any>(comparatorFunction)
    ...
    expect(
      linkedList.find({ value: 2, customValue: "test5" } as any),
    ).toBeNull()
  })
