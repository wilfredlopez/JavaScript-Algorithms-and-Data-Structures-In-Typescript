 ...
 * @return {GraphVertex[]}
 */
export default function bfTravellingSalesman(graph: Graph) {
  ...
  for (
    let cycleIndex = 0; cycleIndex < allPossibleCycles.length; cycleIndex += 1
  ) {
    ...
    if (
      salesmanPathWeight === null || currentCycleWeight < salesmanPathWeight
    ) {
